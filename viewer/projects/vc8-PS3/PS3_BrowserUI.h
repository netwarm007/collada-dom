...
#define MOVE_SPACE 0.5f
#define THUMBNAIL_SIZE 0.25f
#define THUMBNAIL_HALFSIZE 0.125f
...
#define API_ERROR(x) { if(x!=CELL_FS_SUCCEEDED){ printf("PS3: error=0x%x\n",x); } }
...
public:
	...
	{
		(void)document; (void)image; return true; 
	}
